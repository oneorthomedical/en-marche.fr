...
final class Version20200701151729 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE voting_platform_election_pool_result (
          ...
          abstentions INT UNSIGNED DEFAULT 0 NOT NULL, 
          ...
          UNIQUE INDEX UNIQ_13C1C73FC1E98F21 (election_pool_id), 
        ...
        $this->addSql('CREATE TABLE voting_platform_candidate_group_result (
          ...
          uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', 
          UNIQUE INDEX UNIQ_7249D5375F0A9B94 (candidate_group_id), 
